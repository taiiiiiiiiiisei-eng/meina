...
print("めいなブレイン v2.3 起動")
print("文章意味ベクトル＋語順・役割関係学習システム：ON")
print("")
...
def sentence_to_vector(text):
    ...
    for i, word in enumerate(valid_words):
        ...
        positional_vectors.append(vector * position_weight)
