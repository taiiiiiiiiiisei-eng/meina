...
print("めいなブレイン v3.4 起動")
print("文章意味・語順・単語役割＋役割推論＋役割一般化＋文章意図推論＋日本語フレーズ認識システム：ON")
print("")
...
print("v3.4 単語・文脈・意味・語順・単語役割・役割推論・役割一般化・文章意図推論・日本語フレーズ認識開始...")
...
def infer_roles(text):
    ...
    words = [w for w in tokenize(text) if w and w not in "？?！!。、，,"]
    results = []
