...
- 予定時間の合計確認（「今日の予定時間合計」）、所要時間未設定の予定一覧、今日残りの空き時間（「今日あとどれくらい空いてる？」）
...
- 予定カテゴリの設定・解除（「宿題の予定を学校カテゴリにして」）、カテゴリ別一覧（「学校カテゴリの予定を教えて」）、今日/明日/今週のカテゴリ別件数
...
- 場所ベースの予定確認（「図書館での予定を教えて」「場所が図書館の予定を教えて」）、場所未設定一覧（「場所未設定の予定を教えて」）、今日/明日/今週の場所別件数
- 完了履歴と進捗確認（「今日終わった予定を教えて」「今週終わった予定を教えて」「学校カテゴリで今週終わった予定を教えて」「図書館で今週終わった予定を教えて」「今日何個終わった？」「今週何個終わった？」「今日/明日/今週のカテゴリ別進捗」「今日/明日/今週の場所別進捗」）。明日と今週の残り件数には定期予定を未来投影し、今週は過去日の未完了も含める。各回の完了履歴にはカテゴリ・場所・メモなどを保持
