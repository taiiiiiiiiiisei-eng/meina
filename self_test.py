...
def check(text, expected_kind=None, expected_target=None):
...
check("GoogleでVALORANTについて検索して", "web_search", "google")
check("YouTubeでVALORANTの動画を検索して", "web_search", "youtube")
check("YouTubeでUVERworldの曲を探して", "web_search", "youtube")
check("意味不明な命令")
